...
class ModelDesignBanner extends Model {
	public function addBanner($data) {
		$this->db->query("INSERT INTO " . DB_PREFIX . "banner SET name = '" . $this->db->escape($data['name']) . "', name2 = '" . $this->db->escape($data['name2']) . "', blink = '" . $this->db->escape($data['blink']) . "', status = '" . (int)$data['status'] . "'");
	...
	public function editBanner($banner_id, $data) {
		$this->db->query("UPDATE " . DB_PREFIX . "banner SET name = '" . $this->db->escape($data['name']) . "', name2 = '" . $this->db->escape($data['name2']) . "', blink = '" . $this->db->escape($data['blink']) . "', status = '" . (int)$data['status'] . "' WHERE banner_id = '" . (int)$banner_id . "'");
