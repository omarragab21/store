...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			if ($this->user->hasPermission('access', 'extension/module/tmdnewsletter')) {
				$newsletter[] = array(
					'name'	   => $this->language->get('text_newslettersetting'),
					'href'     => $this->url->link('extension/module/tmdnewsletter', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}	
			
			if ($this->user->hasPermission('access', 'extension/subscriber')) {
				$newsletter[] = array(
					'name'	   => $this->language->get('text_subscriber'),
					'href'     => $this->url->link('extension/subscriber', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}

			if ($this->user->hasPermission('access', 'extension/mail')) {
				$newsletter[] = array(
					'name'	   => $this->language->get('text_mailtemplate'),
					'href'     => $this->url->link('extension/mail', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}
			if ($this->user->hasPermission('access', 'extension/quickemail')) {
				$newsletter[] = array(
					'name'	   => $this->language->get('text_quickmail'),
					'href'     => $this->url->link('extension/quickemail', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}
			if ($this->user->hasPermission('access', 'extension/newsletter_analytics')) {
				$newsletter[] = array(
...
// theme options
			...
			// if ($this->user->hasPermission('access', 'extension/module/fastor')) {
			// 	$theme_options[] = array(
			// 		'name'	   => $this->language->get('text_theme_options'),
			// 		'href'     => $this->url->link('extension/module/fastor', 'user_token=' . $this->session->data['user_token'], true),
			// 		'children' => array()
			// 	);	
			// }
			
			// if ($this->user->hasPermission('access', 'extension/module/advanced_grid')) {	
			// 	$theme_options[] = array(
			// 		'name'	   => $this->language->get('text_advanced_grid'),
