...
class ModelAccountCustomer extends Model {
	...
	public function addCustomer($data) {
		...
		$customer_id = $this->db->getLastId();
			...
			$this->model_extension_tmdnewsletter->addSubscriber($data);
			}			
			//newsletter code end 
	...
	public function editNewsletter($newsletter) {
            ...
            //newsletter code start
			if(!empty($newsletter)){
				$query=$this->db->query("select email from " . DB_PREFIX . "newsletter_subscribe where  email = '" .$this->customer->getEmail() . "'");
			...
			$query = $this->db->query("update " . DB_PREFIX . "newsletter_subscribe  set  status='2' where  email = '" .$this->customer->getEmail() . "'");
			}
	...
	public function getCustomerByEmail($email) {
		...
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "customer WHERE LOWER(email) = '" . $this->db->escape(utf8_strtolower($email)) . "' or telephone  = '" . $this->db->escape(utf8_strtolower($email))  . "'");
