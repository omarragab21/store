    ...
    public function getInformation($id)
    {
        ...
        if (ctype_digit($id)) {
            ...
            if ($information_info) {
                ...
                $this->json['data'] = array(
                        'information_id' => (int)$information_info['information_id'],
                        'title' => $information_info['title'],
                        'description' => strip_tags(trim(html_entity_decode($information_info['description'], ENT_QUOTES, 'UTF-8'))),
                        'bottom' => $information_info['bottom'],
                        'sort_order' => $information_info['sort_order'],
                        'status' => $information_info['status'],
                        'language_id' => $information_info['language_id'],
                        'meta_title' => $information_info['meta_title'],
                        'meta_description' => $information_info['meta_description'],
                        'meta_keyword' => $information_info['meta_keyword'],
                        'store_id' => $information_info['store_id'],
                    );
            } else {
