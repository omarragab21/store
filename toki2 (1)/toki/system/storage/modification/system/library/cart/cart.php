					...
					if ($option_query->num_rows) {
						if ($option_query->row['type'] == 'select' || $option_query->row['type'] == 'radio') {
							...
							if ($option_value_query->num_rows) {
								if ($option_value_query->row['price_prefix'] == '+' || $option_value_query->row['price_prefix'] == '=') {
										if ($option_value_query->row['price'] != 0 && $option_value_query->row['price_prefix'] == '=') {
											$has_eql_price = true;
										}
								...
								if ($option_value_query->row['points_prefix'] == '+' || $option_value_query->row['points_prefix'] == '=') {
										if ($option_value_query->row['points']  != 0 && $option_value_query->row['points_prefix'] == '=') {
											$has_eql_points = true;
										}
								...
								if ($option_value_query->row['weight_prefix'] == '+' || $option_value_query->row['weight_prefix'] == '=') {
										if ($option_value_query->row['weight'] != 0 && $option_value_query->row['weight_prefix'] == '=') {
											$has_eql_weight = true;
										}
