	...
	public function index() {
        ...
        // Xtensions Best Checkout
            ...
            if(isset($misc_options['payment']['content'][$this->session->data['payment_method']['code']][$this->config->get('config_language_id')])){
  			...
  			}else if($this->xtensions_checkout->isActive('xtensions_best_checkout',$this->config->get('config_store_id')) && isset($misc_options['order_id_criteria']) && $misc_options['order_id_criteria'] == 'new'){
  				$this->session->data['order_id']   =   $this->model_checkout_order->addOrder( $order_data ) ;
  			}else{
  			    $this->request->get['xtensions_edit_donotaddhistory'] = true;
  			...
  			$this->xtensions_checkout->getXtensionsModel($this->config->get('xtensions_custom_fields_model_path'))->setOrderCountryCode($this->session->data['order_id']);
  			// Xtensions Best Checkout
