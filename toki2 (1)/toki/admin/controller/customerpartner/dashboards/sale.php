...
class Controllercustomerpartnerdashboardssale extends Controller {
	...
	public function index() {		
		...
		$sale_total = number_format(isset($sales['total'])?(float)$sales['total']:0,2);
		$admin_amount = number_format(isset($sales['admin'])?(float)$sales['admin']:0,2);
		$seller_amount = number_format(isset($sales['seller'])?(float)$sales['seller']:0,2);
