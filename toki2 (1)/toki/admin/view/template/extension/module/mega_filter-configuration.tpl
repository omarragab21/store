	...
	<div class="tab-pane" id="tab-style">
		<table class="table table-tbody">
			...
			<tr>
				...
				<td>
					<input class="mf-colorPicker" type="text" name="<?php echo $_configurationName; ?>[background_color_box]" value="<?php echo ! empty( $_configurationValues['background_color_box'] ) ? $_configurationValues['background_color_box'] : ''; ?>" />
				</td>
			</tr>
			<tr>
