...
class ControllerProductProduct extends Controller {
	...
	public function index() {
		...
		if ($product_info) {
			...
			$data['quan'] = $product_info['quantity'];


$data['whatsapp'] = $this->config->get('config_whatsapp');
   $data['href_p']    = urlencode(html_entity_decode($this->url->link('product/product', 'product_id=' . (int)$this->request->get['product_id'])));

//$data['href']    = encodeURIComponent($data['href_p'].replace(/&amp;/g, "&"));
