...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
        ...
        if (isset($this->error['pint'])) {
            $data['error_pint'] = $this->error['pint'];
        } else {
            $data['error_pint'] = '';
        }
        ...
        if (isset($this->error['snapchat'])) {
            $data['error_snapchat'] = $this->error['snapchat'];
        } else {
            $data['error_snapchat'] = '';
        }
...
$this->load->model('localisation/language');
 ...
 foreach ($data['languages'] as $language) {        
        if (isset($this->request->post['config_main_title' . $language['language_id']])) {
            $data['config_main_title'][$language['language_id']] = $this->request->post['config_main_title' . $language['language_id']];
        } else {
            $data['config_main_title'][$language['language_id']] = $this->config->get('config_main_title' . $language['language_id']);
        }
}
        ...
        if (isset($this->request->post['config_pint'])) {
            $data['config_pint'] = $this->request->post['config_pint'];
        } else {
            $data['config_pint'] = $this->config->get('config_pint');
        }
        ...
        if (isset($this->request->post['config_javascript'])) {
			$data['config_javascript'] = $this->request->post['config_javascript'];
		} else {
			$data['config_javascript'] = $this->config->get('config_javascript');
		}


		 if (isset($this->request->post['config_javascript2'])) {
			$data['config_javascript2'] = $this->request->post['config_javascript2'];
		} else {
			$data['config_javascript2'] = $this->config->get('config_javascript2');
		}
